...
public class BookControllerTest {
    ...
    void shouldReturnEditPageForAdmin() throws Exception {
        var books = getBooks();
    ...
    @Test
    @WithMockUser
    void shouldReturnForbiddenForEditPageForUser() throws Exception {
    ...
    @Test
    @WithMockUser(roles = {"ADMIN"})
    void shouldReturnCreatePageForAdmin() throws Exception {
        var authors = getAuthors();
        var genres = getGenres();
    ...
    @Test
    @WithMockUser
    void shouldReturnForbiddenCreatePageForUser() throws Exception {
        var authors = getAuthors();
        var genres = getGenres();
    ...
    @Test
    @WithMockUser(roles = {"ADMIN"})
    void shouldSaveNewBookForAdmin() throws Exception {
    ...
    @Test
    @WithMockUser
    void shouldReturnForbiddenForSaveNewBookForUser() throws Exception {
        var bookServiceInOrder = inOrder(bookService);
    ...
    @Test
    @WithMockUser(roles = {"ADMIN"})
    void shouldSaveBookWhenEditItForAdmin() throws Exception {
        var bookServiceInOrder = inOrder(bookService);
    ...
    @Test
    @WithMockUser
    void shouldReturnForbiddenForSaveBookWhenEditItForUser() throws Exception {
        mockMvc.perform(put("/edit")
                        .with(csrf())
                        .param("id", "1")
                        .content("title=The Best Book&author.id=2&genre.id=2")
    ...
    @Test
    @WithMockUser
    void shouldReturnForbiddenForDeleteBookForUser() throws Exception {
